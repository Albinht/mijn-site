        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-semibold text-gray-900 mb-1.5">
                {copy.fields.phone} <span className="text-gray-500 font-normal">{copy.fields.phoneHint}</span>
              </label>
              <input
                type="tel"
                id="phone"
          ...
          <div className="flex flex-col items-center gap-6">
            <Button 
              ...
              variant="cta"
            >
              {status === 'loading' ? copy.submit.loading : copy.submit.idle} <span>→</span>
            </Button>
            ...
            >
              ...
              <span><strong>{copy.whatsapp.strong}</strong> {copy.whatsapp.rest}</span>
            </a>
          </div>
        </form>
      </div>
