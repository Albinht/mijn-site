        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-1">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Contact</h2>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-500 uppercase mb-2">Telefoon</h3>
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-500 uppercase mb-2">Email</h3>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-600">
              Stuur direct een bericht voor een snelle reactie
            </p>
          </a>
        </div>
      </section>
