export const metadata = {
  ...
  openGraph: {
    title: 'Marketing in Barneveld | Lokale SEO & Google Ads Expert',
    description: 'Marketing diensten in Barneveld. Lokale SEO optimalisatie, Google Ads campagnes en website ontwerp voor Barnevelder bedrijven.',
    images: ['/avatar.png'],
  },
}

export default function MarketingBarnevelLayout({ children }) {
  return children
}
