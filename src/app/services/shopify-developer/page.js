    ...
    <ServicePageTemplate hero={heroData}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              {copy.sections.technical.title.prefix}{' '}
              <span className="bg-[#1795FF] text-white px-2 rounded">{copy.sections.technical.title.highlight}</span>
              {copy.sections.technical.title.suffix ? ` ${copy.sections.technical.title.suffix}` : ''}
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">{copy.sections.technical.subtitle}</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {copy.sections.technical.cards.map((card) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ...
              {copy.sections.services.title.suffix ? ` ${copy.sections.services.title.suffix}` : ''}
            </h2>
                  ...
                  {card.bullets.map((bullet) => (
                    <div key={bullet} className="flex items-start gap-3">
                      <div className="w-5 h-5 flex-shrink-0 mt-1">
                        <Image src="/blog.png" alt={listIconAlt} width={20} height={20} />
                      </div>
      ...
      <section className="py-16 md:py-24 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            {copy.sections.whyNiblah.title.prefix}{' '}
            <span className="bg-[#1795FF] text-white px-2 rounded">{copy.sections.whyNiblah.title.highlight}</span>
            {copy.sections.whyNiblah.title.suffix ? ` ${copy.sections.whyNiblah.title.suffix}` : ''}
          </h2>

          <div className="space-y-4 mb-10">
            {copy.sections.whyNiblah.items.map((item) => (
              <div key={item.number} className="bg-white border-2 border-black rounded-xl p-6 shadow-[4px_4px_0_0_#000] text-left">
                <div className="flex items-start gap-4">
